...
pub fn solve() {
    let day = todo!("What day is it?");
    let part1_example_solution = todo!("What's the first example solution?");
    ...
    let part2_example_solution = todo!("What's the second example solution?");
